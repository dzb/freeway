...
final class Session implements Runnable {
    ...
    Session(Socket socket, HttpRequestHandler handler,
    ...
    public void run() {
        ...
        try {
            ...
            connection = new Http11Connection(socket);
            ...
            var ctx = new HttpContextImpl(jsonCodec, coercer);
    ...
    private void handleWebSocketUpgrade(Http11Connection connection,
        ...
        try {
            ...
            var wsSession = new WebSocketSessionImpl(req.method(), req.path(),
                ...
                connection.outputStream(), match.pathVariables(), connection);

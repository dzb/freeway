...
import com.jujin.freeway.cloud.annotation.None;
 ...
 * (plaintext dev); keystore config ({@code freeway.cloud.rpc.tls.*}) builds
 * file-backed mTLS. Explicit HTTP calls only — no method-level RPC.
 */
